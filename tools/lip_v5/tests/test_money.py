...
# TestRStarFixpoint and TestS0Qualification are DELETED with their machinery (owner's law,
# 2026-07-30): the r* fixpoint and the S=0 qualification pass no longer exist — the law's
# ranking needs no fixpoint, and qualification is a priced cost tested in test_law.py.
