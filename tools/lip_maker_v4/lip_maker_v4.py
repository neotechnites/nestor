...
DENY_SERIES = {"KXRAIN", "KXINXHUD", "KXNDQHUD", "KXMLBMENTION", "KXEARNINGSMENTIONBA", "KXEARNINGSMENTIONPYPL", "KXWNBAMENTION"}                # §7.4 seed deny: measured toxic, 40 markets wide
